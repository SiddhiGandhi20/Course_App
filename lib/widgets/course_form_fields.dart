...
class _CourseFormFieldsState extends State<CourseFormFields> {
  ...
  final TextEditingController _learningPointController =
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDecorativeTextField(widget.titleController,
                TextInputType.text, widget.onTitleChanged),
            _buildLabel("Instructor Name"),
            _buildDecorativeTextField(widget.instructorController,
                TextInputType.text, widget.onInstructorChanged),
            _buildLabel("Description"),
            _buildDecorativeTextField(widget.descriptionController,
                TextInputType.multiline, widget.onDescriptionChanged),
            _buildLabel("What You Will Learn"),
            _buildLearningPointsSection(),
            _buildLabel("Course Tags"),
            _buildTagInputField(),
            _buildLabel("Course Mode"),
            _buildStyledSwitch(widget.isOnlineCourse, "Online Course",
                "Offline Course", widget.onOnlineToggle),
            _buildLabel("Class"),
            _buildDecorativeDropdown(
                widget.selectedCategory,
                ['Select Class', '5th Class', '6th Class', '7th Class'],
            ...
            _buildDecorativeDropdown(widget.selectedLanguage,
                ['English', 'Hindi'], widget.onLanguageSelected),
            ...
            _buildDecorativeDropdown(widget.selectedRating,
                ['1', '2', '3', '4', '5'], widget.onRatingSelected),
            _buildStyledSwitch(widget.isPrivateCourse, "Private Course",
                "Public Course", widget.onPrivateToggle),
            _buildStyledSwitch(
                widget.certificateAvailable,
                "Certificate Available",
                "No Certificate",
                widget.onCertificateToggle),
          ],
        ),
      ),
    );
  ...
  Widget _buildStyledSwitch(bool value, String activeText, String inactiveText,
  ...
  Widget _buildLearningPointsSection() {
    return Column(
      ...
      children: [
        Wrap(
          spacing: 8.0,
          children: widget.learningPoints
              .map((point) => Chip(
                    label: Text(point),
                    deleteIcon:
            ...
            IconButton(
              ...
              onPressed: () {
                if (_learningPointController.text.trim().isNotEmpty) {
                  widget.onLearningPointAdded(
                      _learningPointController.text.trim());
  ...
  Widget _buildDecorativeTextField(TextEditingController controller,
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: Colors.blue.shade100, blurRadius: 5, spreadRadius: 2),
        ],
      ),
      child: TextField(
  ...
  Widget _buildDecorativeDropdown(
  ...
  Widget _buildDurationPriceField(
